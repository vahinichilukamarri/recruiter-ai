...
import {
  ...
  Mail, User, Briefcase, ThumbsUp, AlertCircle
} from "lucide-react";
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
                  <span style={{ 
                    ...
                    fontSize: 10, 
                    fontWeight: 600, 
                    background: candidate.decision === "Selected" ? T.successLight : candidate.decision === "Hold" ? "#FEF3C7" : T.errorLight,
                    color: candidate.decision === "Selected" ? T.success : candidate.decision === "Hold" ? "#D97706" : T.error
                  }}>
                    <CheckCircle2 size={10} /> {candidate.decision}
                  </span>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <div style={{ textAlign: "center", padding: "8px 16px", background: T.primaryLight, borderRadius: 12, minWidth: 100 }}>
                ...
                <div style={{ fontSize: 14, fontWeight: 700, color: T.primary }}>{candidate.decision}</div>
              </div>
